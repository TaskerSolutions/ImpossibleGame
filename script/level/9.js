...
function level9() {
	...
	for (i = -40; i <= 40; i += 20) {newMineEnemy(8, 9, 10, "mine", i, -4, 1);}
	for (i = -40; i <= 40; i += 20) {newMineEnemy(15, 9, 10, "mine", i, 4, 1);}
	for (i = -40; i <= 40; i += 20) {newMineEnemy(22, 9, 10, "mine", i, -4, 1);}
